...
const t = {
  es: {
    subtitle: "Inicia sesión en tu CRM",
    ...
    otpLink: "Acceder con código por correo",
    backToPassword: "Volver a inicio con contraseña",
    ...
    errInvalid: "Credenciales inválidas",
    errConnection: "Error de conexión. Intenta de nuevo.",
    errEmailRequired: "Ingresa tu correo electrónico",
    errCodeRequired: "Ingresa el código de 6 dígitos",
    errCodeInvalid: "Código inválido o expirado",
    errCodeRequest: "Error al solicitar el código",
    successCode: "Código enviado a tu correo",
    forgotLink: "Olvidé mi contraseña",
    forgotTitle: "Restablecer contraseña",
    forgotSubtitle: "Ingresa tu correo para recibir un código de verificación",
    sendResetCode: "Enviar código",
    resetCode: "Código de verificación",
    ...
    passwordChanged: "Contraseña actualizada. Ahora puedes iniciar sesión.",
